        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="FHIR code: kind of group members.",
                        max_length=255,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="FHIR name: human label for the group.",
                        max_length=255,
                    ),
                ),
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True,
                        help_text="FHIR quantity: number of members.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="FHIR characteristic: included/excluded member traits.",
                    ),
                ),
                (
                    "notes",
                    models.TextField(
                        blank=True,
                        help_text="Imported notes or source text for this group.",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="FHIR birthDate: date the person was born.",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="FHIR address: one or more addresses for the person.",
                    ),
                ),
                (
                    "notes",
                    models.TextField(
                        blank=True,
                        help_text="Imported notes or source text for this person.",
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
